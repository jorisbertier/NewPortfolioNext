...
export default function AboutSection() {
    ...
    return (
        <div className="z-30 ss:m-0" id="contact">
            <RevealName name={'Contact'}/>
            <div className="flex max-w-full w-full justify-center items-center rounded-lg bg-red-300 mt-0 h-[60vh] ss:h-[70vh] ss:mt-0">
