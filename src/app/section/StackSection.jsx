        ...
        <div className='h-screen w-screen relative' id="stack">
            ...
            <div className='w-[84%] max-w-full mr-[8%] ml-[8%] -mt-2 sm:-mt-28 xl:mt-3 flex flex-col justify-center md:flex-row md:justify-evenly gap-0 s:gap-4 lg:gap-8 text-center'>
                ...
                <div className='flex flex-col'>
                    <h2 className="text-3xl font-bold my-4 s:my-3 visible sm:invisible text-center">Front</h2>
                    ...
                    <Stack
                        ...
                        skew={12}
                        svg={<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0,0,256,256">
                    ...
                    <Stack
                        gradient={'bg-white'}
                        skew={12}
                        svg={<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0 0 48 48">
                ...
                {/* Backend */}
                <div>
                <h2 className="text-3xl font-bold my-4 s:my-3 visible sm:invisible text-center">Back</h2>
