...
export default function Home() {
  ...
  const [background, setBackground] = useState('#afa18f')
    ...
    <div className='w-screen flex flex-col'>
      ...
      >
        ...
        <div className='fixed bottom-8 flex flex-col gap-4 font-bold text-sm left-11 z-50'>
          <div className='z-50 p-2 rounded-xl cursor-pointer transition-all ease-in' onMouseEnter={() => handleBackground()} onMouseLeave={() => handleBackgroundLeave()} style={{ background: background}}>
      ...
      <div className='max-w-full'>
        ...
        <div className="absolute z-50">
          <div className="fixed right-2 sm:right-6 z-10 p-7">
            <div
