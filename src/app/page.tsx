    ...
    <div className='w-screen flex flex-col max-w-full'>
      ...
      >
        ...
        <div className='fixed left-2 bottom-4 sm:bottom-8 sm:left-11 flex flex-col gap-4 font-bold text-sm z-50'>
          <div className='z-50 p-1 sm:p-2 rounded-lg sm:rounded-xl cursor-pointer transition-all ease-in' onMouseEnter={() => handleBackground()} onMouseLeave={() => handleBackgroundLeave()} style={{ background: background}}>
          ...
          <div className='z-50 p-1 sm:p-2 rounded-lg sm:rounded-xl bg-bgbrown'>
